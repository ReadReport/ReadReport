...
//
///**
// * Created by BHM on 18/1/21.
// */
//
//public class BottomAlterDialog {
//    public enum Style {
//        ActionSheet,
//        Alert
//    }
...
//
//    public BottomAlterDialog(Builder builder) {
...
//    }
//
//    public BottomAlterDialog(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener) {
...
//        alertButtonListView.setOnItemClickListener(new BottomAlterDialog.OnItemClickListener() {
//            @Override
//            public void onItemClick(BottomAlterDialog<?> adapterView, View view, int position, long l) {
...
//    }
//
//    public BottomAlterDialog addExtView(View extView) {
...
//    }
//
//    public BottomAlterDialog setOnDismissListener(OnDismissListener onDismissListener) {
...
//            if (onItemClickListener != null)
//                onItemClickListener.onItemClick(BottomAlterDialog.this, position);
//            dismiss();
//        }
//    }
//
...
//    }
//
//    public BottomAlterDialog setCancelable(boolean isCancelable) {
...
//        }
//
//        public BottomAlterDialog build() {
//            return new BottomAlterDialog(this);
//        }
//    }
//
