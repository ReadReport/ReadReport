...
public class ColorArcProgressBar extends View {
    ...
    private       float longdegree               = dipToPx(1);
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        diameter = a.getLayoutDimension(R.styleable.ColorArcProgressBar_diameter, 3 * getScreenWidth() / 5);

        textSize = a.getLayoutDimension(R.styleable.ColorArcProgressBar_content_size, dipToPx(60));
        ...
        textColor = a.getColor(R.styleable.ColorArcProgressBar_content_color, Color.BLACK);
