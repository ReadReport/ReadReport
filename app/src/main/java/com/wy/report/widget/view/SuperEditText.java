...
public class SuperEditText extends AppCompatEditText {
    ...
    * */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // a. 点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_clickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_click, R.drawable.btn_delete_normal);
        ...
        // b. 未点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_unclickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_unclick, R.drawable.btn_delete_normal);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ...
        // 1. 获取资源ID
        ic_deleteResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_delete, R.drawable.btn_delete_normal);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
