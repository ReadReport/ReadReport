...
import com.wy.report.widget.view.wheel.common.WheelConstants;
import com.wy.report.widget.view.wheel.common.WheelViewException;
import com.wy.report.widget.view.wheel.graphics.DrawableFactory;
import com.wy.report.widget.view.wheel.util.WheelUtils;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
     ...
     * @param textView
     */
    protected void refreshTextView(int position, int curPosition, View
     ...
     * @param textAlpha
     */
    protected void setTextView(View itemView, TextView textView, int textColor, float textSize, float textAlpha) {
